class Solution {
    ...
    /**
     * IDEA:
     * - Use two pointers to loop over the array. The left pointer keeps track of the buy point,
     ...
     * If the new maxProfit (difference) is greater than one seen before, update maxProfit with the
